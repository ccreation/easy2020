...
@section("content")
    ...
    <div class="container pt-2 pb-5" style="min-height: 500px;">
        <h4 class="mb-3 float-right" style="color: #512293; line-height: 40px;"><b><i class="fas fa-comment-dots"></i> <span>{{$plugin->{"name_".app()->getLocale()} }}</span></b></h4>
        ...
        <div class="mb-2"><span class="plix">1</span> <span>{{__("l.create_an_account_in_the_following_website")}} : </span> <a href="https://app.jivosite.com" target="_blank">https://app.jivosite.com</a>.</div>
        <div class="mb-2"><span class="plix">2</span> <span>{{__("l.copy_the_code_from_your_account_settings_and_paste_it_here")}} : </span> <small>(<a href="https://www.jivochat.com/help/installation/find-code.html" target="_blank">https://www.jivochat.com/help/installation/find-code.html</a>)</small></div>

        <form action="{{route("client.plugins.save_plugin_data")}}" id="save_plugin_data" class="formi" method="post">
            @csrf

            <input type="hidden" name="plugin_id" value="4">
