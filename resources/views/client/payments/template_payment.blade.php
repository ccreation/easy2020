...
@section("content")
    ...
    <div class="container pt-2 pb-5" style="min-height: 500px;">
        ...
        @if($website)
            <h4 class="mb-3 text-center" style="color: #512293"><b><i class="fa fa-globe"></i> <span>{{@$website->{"name_".app()->getLocale()} }}</span></b></h4>
        @else
            <h4 class="mb-3 text-center" style="color: #512293"><b><i class="fa fa-brush"></i> <span>{{$template->{"name_".app()->getLocale()} }}</span></b></h4>
        @endif
        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-sm mb-5" style="padding: 3rem!important;">
                    <h4 class="text-center mt-0 mb-3"><b>{{__("l.amount_required")}}</b></h4>
                    <table class="table table-bordered">
                        @if($website)
                            <tr>
                                <td width="70%">{{__("l.website")}}</td>
                                <td><span></span> <span>{{@$website->{"name_".app()->getLocale()} }}</span></td>
                            </tr>
                        @endif
                        <tr>
                            <td>{{__("l.template")}}</td>
                            <td><span></span> <span>{{$template->{"name_".app()->getLocale()} }}</span></td>
                        </tr>
                        <tr>
                            <td><b>{{__("l.price")}}</b></td>
                            <td><b>{{$template->price}}</b> <b>{{__("l.rs")}}</b></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm" style="padding: 3rem!important;">
                    ...
                    <div class="tab-content" style="min-height: 500px;">
                        ...
                        <div id="nav-tab-bank" class="tab-pane fade show active">
                            <form action="{{route("client.payments.do_template_payment")}}" method="post" class="mt-40" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div id="nav-tab-card" class="tab-pane fade pt-20">
                            @if($checkoutId)
                                ...
                                <form action="{{route("client.payments.hyperpay_template")}}" class="paymentWidgets" data-brands="VISA MASTER AMEX"></form>
