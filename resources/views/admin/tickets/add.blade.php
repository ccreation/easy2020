...
@section("content")
    ...
    <div class="container pb-5 pt-1">
        ...
        <h3 class="mb-3 text-center" style="color: #543c93;">{{__("l.open_ticket")}}</h3>

        <form action="{{route("admin.tickets.send")}}" method="post" id="send_ticket" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="website_id" required>
                            ...
                            @foreach($clients as $client)
                                <optgroup label="العميل : {{$client->name}}">
