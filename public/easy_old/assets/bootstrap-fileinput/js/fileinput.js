...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="icon-trash-alt"></i>',
                    ...
                    uploadRetryIcon: '<i class="icon-reload"></i>',
                    ...
                    dragIcon: '<i class="icon-arrows-alt"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="icon-plus1 text-warning"></i>',
                    indicatorSuccess: '<i class="icon-check text-success"></i>',
                    indicatorError: '<i class="icon-info-circle text-danger"></i>',
                    indicatorLoading: '<i class="icon-hourglass-half text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        cancelIcon: '<i class="fa fa-minus-circle"></i>',
